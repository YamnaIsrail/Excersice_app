    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Method 2", style: headingStyle,),
            ...
            Center(
              child: Image.asset('assets/kegel/balloons.png', height: 150),
            ),
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const HowToDoKegel3()),
                );
              },
